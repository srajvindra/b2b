...
export default function LoginScreen({ onLogin }: LoginScreenProps) {
  const [email, setEmail] = useState("csr.nina@heropm.com")
  ...
  function handleCredentialsSubmit(e: React.FormEvent) {
    ...
    if (email === "csr.nina@heropm.com" && password === "Passw0rd!23") {
      onLogin()
    } else {
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleCredentialsSubmit} className="space-y-4">
              ...
              <div className="text-center text-sm text-muted-foreground">
                ...
                <p className="font-mono text-xs bg-muted p-2 rounded">csr.nina@heropm.com / Passw0rd!23</p>
              </div>
            </form>
            ...
            <div className="space-y-2">
              ...
              <Select value={supportSubject} onValueChange={setSupportSubject}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="2fa-problem">2FA Problem</SelectItem>
