...
import { contactDirectoryQuickActions } from "@/lib/quickActions"
...
export default function ContactsDirectoryPage() {
  ...
  useQuickActions(contactDirectoryQuickActions, { subtitle: "Contact Directory" })
    ...
    <div className="p-6">
      ...
      <div className="flex items-center gap-1 mb-6 border-b border-border">
        <button
          ...
          className={`px-4 py-2.5 text-sm font-medium transition-colors relative ${activeTab === "owners"
              ? "text-teal-600"
        ...
        <button
          ...
          className={`px-4 py-2.5 text-sm font-medium transition-colors relative ${activeTab === "tenants"
              ? "text-teal-600"
              : "text-muted-foreground hover:text-foreground"
            }`}
        >
      ...
      <LoadMorePagination
        ...
        label="contacts"
        onLoadMore={() => setVisibleCount((prev) => Math.min(prev + 10, filteredData.length))}
      />
    </div>
  )
}
