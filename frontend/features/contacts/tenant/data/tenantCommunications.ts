...
export function getTenantCommunications(
  ...
  return [
    ...
    { id: "e1", type: "email", from: { name: staffName, contact: staffEmail }, to: { name: tenantName, contact: tenantEmail }, subject: "Follow-up: Lease Renewal Options", preview: "Sent follow-up email regarding lease renewal.", timestamp: "11/28/2025, 3:15 PM", fullDate: "11/28/2025, 3:15 PM", date: new Date("2025-11-28T15:15:00"), isRead: true, isIncoming: false, escalatedTo: "David Wilson (GM)", escalatedAt: "11/28/2025" },
    { id: "g1", type: "sms", from: { name: "Mike Davis", contact: "(216) 555-4567" }, to: { name: "Building Residents", contact: "" }, preview: "Building maintenance notice.", content: "Building maintenance notice: Water will be shut off on Monday 9-11 AM.", timestamp: "12/6/2025, 9:00 AM", fullDate: "12/6/2025, 9:00 AM", date: new Date("2025-12-06T09:00:00"), isRead: true, isIncoming: false, isGroupChat: true, groupParticipants: ["Mike Davis", tenantName, "John Smith"], unreadCount: 3, escalatedTo: "Oliver Torres (VP)", escalatedAt: "12/6/2025" },
