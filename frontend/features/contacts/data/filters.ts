export const OWNER_CONTACT_FILTER_FIELDS = [
    "Integration",
    "Status",
    "Property Group(s)",
    "In Relationship(s)",
  ...
  export const OWNER_CONTACT_FIELDS_WITH_SELECT_ALL = [
    "Property Group(s)",
    "In Relationship(s)",
    "Tagged With Any",
    "Tagged With All",
  ...
  export function getOwnerContactFilterOptions(field: string): string[] {
  ...
  export const TENANT_CONTACT_FILTER_FIELDS = [
    "Integration",
    "Status",
    "Property Group(s)",
    "In Relationship(s)",
  ...
  export const TENANT_CONTACT_FIELDS_WITH_SELECT_ALL = ["Stage", "Source", "Tagged With Any", "Tagged With All"]
  
  export function getTenantContactFilterOptions(field: string): string[] {
    if (field === "Status") return ["Active", "Inactive"]
    if (field === "Integration") return ["AppFolio", "Buildium", "RentManager", "Yardi", "None"]
