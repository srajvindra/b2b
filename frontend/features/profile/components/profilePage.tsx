...
import { initialBusinessInfo, initialPersonalInfo } from "@/features/profile/data/profileMockData"
import type { BusinessInfo, PersonalInfo } from "@/features/profile/types"
                                        ...
                                        {passwordData.newPassword && (
                                            <div className="space-y-2 pt-1">
                                                ...
                                                <div className="flex gap-1">
                                                    <div
                                                        className={`h-1.5 flex-1 rounded-full transition-all ${passwordData.newPassword.length > 0
                                                    ...
                                                    ></div>
                                                    <div
                                                        className={`h-1.5 flex-1 rounded-full transition-all ${passwordStrength?.label === "Medium" || passwordStrength?.label === "Strong"
                                                                ? passwordStrength?.label === "Medium"
                                                                    ? "bg-amber-500"
                                                                    : "bg-green-500"
                                                                : "bg-muted"
                                                    ...
                                                    ></div>
                                                    <div
                                                        className={`h-1.5 flex-1 rounded-full transition-all ${passwordStrength?.label === "Strong" ? "bg-green-500" : "bg-muted"
                                                            }`}
                                                    ></div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <Input
                                                ...
                                                className={`pr-10 ${passwordData.confirmPassword
                                                        ? passwordsMatch
                                ...
                                <div className="lg:col-span-2">
                                    <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 sticky top-4">
                                        ...
                                        <ul className="space-y-3">
                                            <li
                                                className={`flex items-center gap-3 p-2 rounded-lg transition-colors ${hasMinLength ? "bg-green-50 dark:bg-green-900/20" : "bg-transparent"
                                                    }`}
                                            >
                                                <div
                                                    className={`h-5 w-5 rounded-full flex items-center justify-center ${hasMinLength ? "bg-green-500 text-white" : "bg-slate-200 dark:bg-slate-700"
                                                        }`}
                                                >
                                                    {hasMinLength ? (
                                                ...
                                                <span
                                                    className={`text-sm ${hasMinLength ? "text-green-700 dark:text-green-400 font-medium" : "text-muted-foreground"
                                                        }`}
                                                >
                                            ...
                                            <li
                                                className={`flex items-center gap-3 p-2 rounded-lg transition-colors ${hasUppercase ? "bg-green-50 dark:bg-green-900/20" : "bg-transparent"
                                                    }`}
                                            >
                                                <div
                                                    className={`h-5 w-5 rounded-full flex items-center justify-center ${hasUppercase ? "bg-green-500 text-white" : "bg-slate-200 dark:bg-slate-700"
                                                        }`}
                                                >
                                                    {hasUppercase ? (
                                                        <Check className="h-3 w-3" />
                                                ...
                                                <span
                                                    className={`text-sm ${hasUppercase ? "text-green-700 dark:text-green-400 font-medium" : "text-muted-foreground"
                                                        }`}
                                                >
                                            ...
                                            <li
                                                className={`flex items-center gap-3 p-2 rounded-lg transition-colors ${hasNumber ? "bg-green-50 dark:bg-green-900/20" : "bg-transparent"
                                                    }`}
                                            >
                                                <div
                                                    className={`h-5 w-5 rounded-full flex items-center justify-center ${hasNumber ? "bg-green-500 text-white" : "bg-slate-200 dark:bg-slate-700"
                                                        }`}
                                                >
                                                    {hasNumber ? (
                                                        <Check className="h-3 w-3" />
                                                ...
                                                <span
                                                    className={`text-sm ${hasNumber ? "text-green-700 dark:text-green-400 font-medium" : "text-muted-foreground"
                                                        }`}
                                                >
                                                    One number
                                                </span>
                                            ...
                                            <li
                                                className={`flex items-center gap-3 p-2 rounded-lg transition-colors ${hasSpecial ? "bg-green-50 dark:bg-green-900/20" : "bg-transparent"
                                                    }`}
                                            >
                                                <div
                                                    className={`h-5 w-5 rounded-full flex items-center justify-center ${hasSpecial ? "bg-green-500 text-white" : "bg-slate-200 dark:bg-slate-700"
                                                        }`}
                                                >
                                                    {hasSpecial ? (
                                                        <Check className="h-3 w-3" />
                                                ...
                                                <span
                                                    className={`text-sm ${hasSpecial ? "text-green-700 dark:text-green-400 font-medium" : "text-muted-foreground"
                                                        }`}
                                                >
