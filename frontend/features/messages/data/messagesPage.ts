...
export function getPrivateMessagesForContact(contact: Contact): CommMessage[] {
  ...
  return [
    ...
    },
    {
      ...
      recipientName: staffName,
      recipientContact: staffPhone,
      content: "Incoming call from tenant regarding lease renewal.",
      timestamp: "2:45 PM",
      date: "Yesterday",
      isRead: true,
      callDuration: "3 min 10 sec",
      callNotes: `${contact.name} called to ask about:\n- Lease renewal timeline\n- Parking availability\n- Pet policy changes`,
    },
    {
      id: "m6",
      type: "email",
    ...
    },
    {
      ...
      recipientName: contact.name,
      recipientContact: contact.phone,
      content: "Follow-up call regarding parking and lease questions.",
      timestamp: "11:00 AM",
      date: "Today",
      isRead: true,
      callDuration: "7 min 45 sec",
      callNotes: `Called ${contact.name} to follow up on:\n- Confirmed parking spot included in renewal\n- Reviewed updated pet deposit terms\n- Scheduled in-person lease signing for next Tuesday`,
    },
  ]
}
