...
type CommChannel = "email" | "sms" | "call"
...
// Generate private messages for a contact
const getPrivateMessagesForContact = (contact: Contact): CommMessage[] => {
...
// Generate group messages for a contact
const getGroupMessagesForContact = (contact: Contact): { name: string; participants: string[]; messages: CommMessage[]; unreadCount: number }[] => {
  const staffName = "Richard Surovi"
